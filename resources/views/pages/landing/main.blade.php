    ...
    <nav id="main_nav" class="navbar navbar-expand-lg navbar-light bg-white shadow">
        <div class="container d-flex justify-content-between align-items-center">
            <a class="navbar-brand h1" href="{{ route('home') }}">
                ...
                <span class="text-dark h4">BEM</span> <span class="text-primary h4">FASILKOM</span> <span
                    class="text-dark h4">UNEJ</span>
            </a>
            ...
            <div class="align-self-center collapse navbar-collapse flex-fill  d-lg-flex justify-content-lg-between"
                ...
                <div class="flex-fill mx-xl-5 mb-2">
                    <ul class="nav navbar-nav d-flex justify-content-between mx-xl-5 text-center text-dark">
                        ...
                        <li class="nav-item">
                            <a class="nav-link btn-outline-primary rounded-pill px-3"
                                href="{{ route('ppmb') }}">PPMB</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link btn-outline-primary rounded-pill px-3"
                                href="{{ route('profil') }}">Tentang Kami</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link banner-button btn rounded-pill btn-outline-primary btn-sm px-md-4"
                                href="{{ route('login') }}" role="button"><i class="fa fa-user"></i> Login</a>
                        </li>
                        {{--                        <li class="nav-item">--}}
                ...
                {{--                    <a class="banner-button btn rounded-pill btn-outline-primary btn-lg px-4" href="{{ route('login') }}"
                role="button">Masuk</a>--}}
                {{--                    <a href="{{ route('login') }}" class="btn btn-primary rounded-pill btn-block
                shadow px-4 py-2">Masuk</a>--}}
                {{--                </div>--}}
            </div>
        </div>
    </nav>
            ...
            <div class="row py-4">
                ...
                <div class="col-lg-3 col-12 align-left">
                    <a class="navbar-brand" href="{{ route('home') }}">
                        ...
                        <span class="text-light h5">BEM</span> <span class="text-light h5 semi-bold-600">FASILKOM</span>
                        <span class="text-light h5">UNEJ</span>
                    </a>
                    ...
                    <ul class="list-unstyled text-light light-300">
                        ...
                        <li class="pb-2">
                            <i class='bx-fw bx bxs-chevron-right bx-xs'></i><a
                                class="text-decoration-none text-light py-1" href="{{ route('profil') }}">Tentang
                                Kami</a>
                        </li>
                        {{--                            <li class="pb-2">--}}
                        ...
                        <li class="pb-2">
                            <i class='bx-fw bx bxs-chevron-right bx-xs'></i><a
                                class="text-decoration-none text-light py-1" href="{{ route('ppmb') }}">PPMB</a>
                        </li>
                    </ul>
                </div>
                    ...
                    <ul class="list-unstyled text-light light-300">
                        <li class="pb-2">
                            <i class='bx-fw bx bx-phone bx-xs'></i><a class="text-decoration-none text-light py-1"
                                href="https//wa.me/6282234077219" target="_blank">+6282234077219</a>
                        </li>
                        <li class="pb-2">
                            <i class='bx-fw bx bx-mail-send bx-xs'></i><a class="text-decoration-none text-light py-1"
                                href="mailto:bemilkomunej@cs.unej.ac.id">bemilkomunej@cs.unej.ac.id</a>
                        </li>
                    </ul>
                </div>
                ...
                <div class="row pt-2">
                    <div class="col-lg-6 col-sm-12">
                        <p class="text-lg-start text-center text-light light-300">
                            © Copyright 2023 BEM FASILKOM UNEJ. All Rights Reserved.
                        </p>
                    </div>
                    <div class="col-lg-6 col-sm-12">
