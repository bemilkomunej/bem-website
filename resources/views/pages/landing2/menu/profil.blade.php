        ...
        <div class="container" data-aos="fade-up">
            ...
            <div class="row feture-tabs" data-aos="fade-up">
                <div class="col-lg-6">
                    ...
                    <div class="tab-content" style="text-align: justify;">
                        ...
                        <div class="tab-pane fade show active" id="tab1">
                            <p>Sebelum berdirinya <b>BEM PSSI</b>, telebih dahulu berdiri organisasi Himpunan Mahasiswa Sistem Informasi
                                Pada tahun 2016 PSSI akan dijadikan Fakultas sehingga harus ada <b>organisasi tertinggi</b>.
                                Putusan pertama pada rapat pendiri adalah nama ormawa yaitu HIMASIF setara BEM, mengingat masih berbentuk program studi.
                                Bem Fasilko Unej didirikan tanggan <b>22 Juni 2015</b> bertempat di Ruang 1/ Ruang Aula Lt. 2 di gedung UPT Perpustakaan-24A Universitas Jember</p>
                ...
                <div class="col-lg-6">
                    ...
                    <!-- widt 560 x 314 -->
                    <iframe class="speakerdeck-iframe" frameborder="0" src="https://speakerdeck.com/player/326090e1c47343d9b38f22fb736d9624" title="Profil BEM FASILKOM UNEJ 2022" allowfullscreen="true" mozallowfullscreen="true" webkitallowfullscreen="true" style="border: 0px; background: padding-box padding-box rgba(0, 0, 0, 0.1); margin: 0px; padding: 0px; border-radius: 6px; box-shadow: rgba(0, 0, 0, 0.2) 0px 5px 40px; width: 100%; height: 100%; min-height: 314px" data-ratio="1.78343949044586"></iframe>
                </div>
            ...
            <div class="row feature-icons" data-aos="fade-up">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-4 text-center" data-aos="fade-right" data-aos-delay="100">
                        <img src={{asset('landing2/assets/img/clients/ormawa/ormawa-0.png')}} class="img-fluid p-4" alt="">
                    </div>
                    ...
                    <div class="col-xl-8 d-flex content">
                        <div class="row align-self-center gy-4">
                            ...
                            <div class="col-md-6 icon-box" data-aos="fade-up" data-aos-delay="100">
                                ...
                                <lottie-player src="https://assets9.lottiefiles.com/packages/lf20_98e3dlbb.json" background="transparent" speed="2" style="width: 64px; height: 64px;" autoplay loop></lottie-player>
                                <div>
                                    <h4>Lambang UNEJ</h4>
                            ...
                            <div class="col-md-6 icon-box" data-aos="fade-up" data-aos-delay="100">
                                ...
                                <lottie-player src="https://assets9.lottiefiles.com/packages/lf20_98e3dlbb.json" background="transparent" speed="2" style="width: 50px; height: 50px;" autoplay loop></lottie-player>
                                <div>
                                    <h4>Warna Abu-abu</h4>
        ...
        <div class="container" data-aos="fade-up">
            ...
            <div class="row gy-4">
                ...
                <div class="col-lg-3 col-md-6">
                    <a href="https://docs.google.com/document/d/1535B_pUuoRjxIG2Y29UwaQm5fpjAvhIU/edit?usp=sharing&ouid=101162738640501586785&rtpof=true&sd=true">
                        <div class="count-box">
                            <!-- <i class="bi bi-emoji-smile"></i> -->
                            <lottie-player src="https://assets9.lottiefiles.com/packages/lf20_huy6ppqm.json" background="transparent" speed="1" style="width: 100px; height: 100px;" autoplay loop></lottie-player>
                            <div>
                ...
                <div class="col-lg-3 col-md-6">
                    <a href="https://docs.google.com/document/d/1UUkgml3A0aD7Ee99VNa95fY1EWfKZE_2/edit?usp=sharing&ouid=101162738640501586785&rtpof=true&sd=true">
                        <div class="count-box">
                            <!-- <i class="bi bi-journal-richtext" style="color: #ee6c20;"></i> -->
                            <lottie-player src="https://assets6.lottiefiles.com/packages/lf20_7fyq4w1u.json" background="transparent" speed="1" style="width: 100px; height: 100px;" autoplay loop></lottie-player>
                            <div>
                ...
                <div class="col-lg-3 col-md-6">
                    <a href="https://docs.google.com/document/d/1RlVcer04HKIDv-1-o5YJwReZIIqUJsEd/edit?usp=sharing&ouid=101162738640501586785&rtpof=true&sd=true">
                        <div class="count-box">
                            <!-- <i class="bi bi-headset" style="color: #15be56;"></i> -->
                            <lottie-player src="https://assets5.lottiefiles.com/packages/lf20_uxm22dh7.json" background="transparent" speed="1" style="width: 100px; height: 100px;" autoplay loop></lottie-player>
                            <div>
                ...
                <div class="col-lg-3 col-md-6">
                    <a href="https://docs.google.com/document/d/1KnOJNWyp8hcICU_8JGjydRZfNCyDVhMj/edit?usp=sharing&ouid=101162738640501586785&rtpof=true&sd=true">
                        <div class="count-box">
                            <!-- <i class="bi bi-people" style="color: #bb0852;"></i> -->
                            <lottie-player src="https://assets1.lottiefiles.com/packages/lf20_qso3udhf.json" background="transparent" speed="1" style="width: 100px; height: 100px;" autoplay loop></lottie-player>
                            <div>
                                <!-- <span data-purecounter-start="0" data-purecounter-end="15" data-purecounter-duration="2" class="purecounter"></span> -->
                                <span>GBHK</span>
                                <p>Download</p>
