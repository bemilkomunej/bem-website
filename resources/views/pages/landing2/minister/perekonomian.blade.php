  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-6 hero-img" data-aos="zoom-out" data-aos-delay="200">
        <img src={{asset("landing2/assets/img/team/Team-Perekonomian.png")}} class="img-fluid" alt="">
      </div>
    </div>
  </div>
            ...
            <div class="row gy-4 justify-content-center">
                ...
                <div class="col-lg-12 col-md-12" data-aos="fade-up" data-aos-delay="200">
                    <div class="service-box blue">
                        ...
                        <h3>ICE</h3>
                        <p>Kegiatan perlombaan tersebut sebagai upaya untuk meningkatkan kualitas Mahasiswa Fakultas Ilmu Komputer dalam merancang ide kewirausahaan sehingga mampu mengambil peran sebagai agen perubahan dalam memajukan pembangunan ekonomi di Indonesia.</p>
                        <a href="https://instagram.com/fasilkom_ice" class="read-more"><span>Selengkapnya</span> <i class="bi bi-arrow-right"></i></a>
                    </div>
                </div>
